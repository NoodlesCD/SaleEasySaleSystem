...
public class Inventory {
	...
	public static BorderPane addToInventory() {
		// Contains all of the items on the new sale page.
		BorderPane inventoryPageContainer = new BorderPane();

		// search by invoice number or customer
		// Header, containing title, invoice number and customer
		Label titleLabel = new Label("Inventory Management: Add Item");
		...
		String itemName, String manufacturer, int rating, double price, double cost, String sku,
		String description, int inventoryCount
		
		Label name = new Label("SKU");
		nameField = new TextField();
		VBox nameBox = new VBox(10, name, nameField);
		
		Label address = new Label("Name");
		addressField = new TextField();
		VBox addressBox = new VBox(10, address, addressField);
		
		Label city = new Label("Description");
